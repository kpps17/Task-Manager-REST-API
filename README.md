...
<img src="https://img.shields.io/badge/made----by-kpps17-purple?style=flat">
...
2. __Secure routes__ : A route which ***cannot*** be accessed without authentication i.e. a server issued JSON Web Token (JWT) to that particular user is required for access. 
